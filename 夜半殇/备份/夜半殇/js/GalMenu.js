        ...
        init: function(options) {
            ...
            $this.each(function(i) {
                ...
                function(e) {
                    ...
                    if(bodyHe-Coords.clientY<200) top=bodyHe-350;
                    if($('body')[0] === e.target){if(bodyWi-Coords.clickX<150) left=bodyWi-50} 
					else {if(bodyWi-Coords.clientX<150) left=bodyWi-320};
					//防止菜单超出可见区域，不需要可注释掉
                    $menu.css({
                        top: top + 'px',
                        left: left + 'px',
